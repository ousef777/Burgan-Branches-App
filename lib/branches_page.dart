...
class BranchesPage extends StatelessWidget {
  ...
  final List<BankBranch> burganBankBranches = [
    ...
    BankBranch(
        ...
        hours: "Sunday – Wednesday: 9:00 am – 1:00 pm; 5:00 pm – 7:00 pm, Thursday: 9:00 am – 1:00 pm"),
    BankBranch(
        name: "Marina Mall",
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text("Branches"), backgroundColor: Colors.lightBlue,),
            ...
            return Card(
              child: InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    Text(burganBankBranches[index].name, style: const TextStyle(fontSize: 28)),
